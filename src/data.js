...
export const homeSolutionsCardData = [
  {
    id: 1,
    title: 'Manpower Recruitment',
    icon: 'uil uil-users-alt',
    img: '/img/sections/pro-service-training.jpg',
    description:
      'End-to-end hiring support to identify, screen, and place the right talent for your business needs.'
  },
  {
    id: 2,
  ...
  },
  {
    ...
    img: '/img/sections/pro-service-development.jpg',
    description:
      'Professional HR advisory services to improve workforce planning, policies, and employee management.'
  },
  {
    id: 4,
    title: 'Banking & Financial Services Support',
    icon: 'uil uil-university',
    img: '/img/sections/service-training.jpg',
    description:
      'Specialized staffing and support services for banking and financial institutions across key functions.'
  },
  {
    id: 5,
...
export const recruitmentServices = [
  {
    ...
    icon: 'uil uil-briefcase-alt',
    description:
      'We source, assess, and place full-time professionals aligned to your role requirements, team culture, and business goals.'
  },
  {
    id: 2,
    ...
    icon: 'uil uil-users-alt',
    description:
      'Scale quickly with contingent talent for seasonal demand, project surges, and urgent hiring needs without sacrificing quality.'
  },
  {
    id: 3,
    title: 'Onsite Workforce Management',
    icon: 'uil uil-building',
    description:
      'We streamline candidate attraction, onboarding, and operational coordination at your location for faster workforce execution.'
  }
];

export const recruitmentExpertise = [
